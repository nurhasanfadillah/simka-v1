    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="outline" disabled={!selectedYearId} onClick={() => handleExport('excel')}>Excel</Button>
          <Button variant="outline" disabled={!selectedYearId} onClick={() => handleExport('pdf')}>PDF</Button>
        </div>
      </div>
